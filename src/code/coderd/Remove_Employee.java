...
class Remove_Employee implements ActionListener{
    ...
    Remove_Employee(){
        f=new JFrame(" Employee Management System - Remove Employee");
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("code/icons/remove.png"));
        l5.setIcon(img);
        f.add(l5);
